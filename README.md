...
<li>Consulta o retorno do link https://viacep.com.br/ws/RS/Gravatai/Barroso/json, é retornado os mesmos atributos do consulta CEP válido das duas cidades.</li>
